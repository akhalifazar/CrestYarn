...
#[derive(Debug)]
pub struct CrestYarnProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CrestYarnProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CrestYarn processing");
    
    let mut processor = CrestYarnProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CrestYarnProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CrestYarnProcessor::new(false);
